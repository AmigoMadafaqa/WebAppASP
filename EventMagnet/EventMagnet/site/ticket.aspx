<%@ Page Title="" Language="C#" MasterPageFile="~/site/site.Master" AutoEventWireup="true" CodeBehind="tickets.aspx.cs" Inherits="EventMagnet.site.tickets" %>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            <select value="month">
                                                ...
                                                <option name="min" id="min">RM0 - RM50</option>
                                                <option name="standard" id="standard">RM50 - RM100</option>
                                                <option name="hight" id="hight">RM100 - RM200</option>
                                            </select>
                                        </div>
                                        <div class="col-lg-3">
                                            <fieldset>
                ...
                <div class="col-lg-4">
                    <div class="ticket-item">
                        <div class="thumb">
                            ...
                            <div class="price">
                                <span>1 ticket<br>from <em>RM25</em></span>
                            </div>
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="ticket-item">
                        <div class="thumb">
                            ...
                            <div class="price">
                                <span>1 ticket<br>from <em>RM20</em></span>
                            </div>
                        </div>
                        <div class="down-content">
                ...
                <div class="col-lg-4">
                    <div class="ticket-item">
                        <div class="thumb">
                            ...
                            <div class="price">
                                <span>1 ticket<br>from <em>RM30</em></span>
                            </div>
                        </div>
                        <div class="down-content">
                ...
                <div class="col-lg-4">
                    <div class="ticket-item">
                        <div class="thumb">
                            ...
                            <div class="price">
                                <span>1 ticket<br>from <em>RM40</em></span>
                            </div>
                        </div>
                        <div class="down-content">

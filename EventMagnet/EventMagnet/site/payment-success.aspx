<%@ Page Title="" Language="C#" MasterPageFile="~/site/site.Master" AutoEventWireup="true" CodeBehind="payment-success.aspx.cs" Inherits="EventMagnet.site.payment_success" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="card">
            ...
            <div class="payment-success">
                <div class="card">
                    ...
                    <br />
                    <p>
                        Transaction reference: <%= custOrderUUID %><br />
                        Order date: <%= custOrder.create_datetime == null ? "N/A" : custOrder.create_datetime.ToString() %><br />
                    </p>
    ...
    <div style="margin: 40px auto 20px; display: flex; justify-content: center;">
        ...
        <asp:Button ID="btnOrderPage" runat="server" Text="Go to Ticket History" CssClass="btn btn-outline-dark mx-3" OnClick="btnOrderPage_Click" />
    </div>
</asp:Content>
